...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'easyadmin.config' => [
                'site_name' => 'Kylan <em style="font-size: 80%;">Corp.</em>',
                'entities' => [
                    'User' => [
