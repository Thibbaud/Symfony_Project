        ...
        foreach ($context['_seq'] as $context["_key"] => $context["upcome"]) {
            ...
            echo "\" alt=\"\">
                        <div class=\"card-body\">
                            <h4 class=\"card-title\">";
            // line 16
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["upcome"], "original_title", []), "html", null, true);
            echo "</h4>
                            <h6>";
            // line 17
...
";
    ...
    {
        return array (  114 => 28,  99 => 19,  95 => 18,  91 => 17,  87 => 16,  82 => 14,  77 => 11,  73 => 10,  65 => 4,  56 => 3,  27 => 1,);
    }
    ...
    <div class=\"container mt-4\">
        <div class=\"row\">
            ...
            {% for upcome in upcoming.results %}
                ...
                <div class=\"col-sm-3 d-flex\">
                    <div class=\"card h-150 mt-3\">
                        <img class=\"card-img-top\" src=\"http://image.tmdb.org/t/p/w185{{ upcome.poster_path }}\" alt=\"\">
                        <div class=\"card-body\">
                            <h4 class=\"card-title\">{{ upcome.original_title }}</h4>
                            <h6>{{ upcome.release_date | date(\"d/m/Y\") }}</h6>
